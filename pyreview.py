...
PREFIX = """
This feedback was generated by a large language model (LLM): {model}. LLMs are often wrong; they may not understand the intent of your code.
...
def main():
    ...
    prompt_format = functools.partial(args.prompt.format, nudge=args.nudge)
...
def parse_args():
    ...
    argparser.add_argument('--prompt', nargs='?', type=argparse.FileType('r'), default=None)
    ...
    args.prompt = args.prompt.read() if args.prompt else PROMPT
